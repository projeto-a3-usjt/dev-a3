...
-- Dumping data for table projtest.cadastros: ~1 rows (approximately)
INSERT INTO `cadastros` (`id_usuário`, `username`, `senha`, `nome`, `tipo_conta`) VALUES
...
-- Dumping data for table projtest.cardápio: ~0 rows (approximately)
INSERT INTO `cardápio` (`id_prato`, `nome_prato`, `descrição`, `preço`, `id_tipo`) VALUES
	(1, 'Filé de frango à parmegiana', 'Servido com arroz branco e batata frita.', 39.99, 1),
	(2, 'X-Bacon', '180g de carne bovina, queijo mussarela, fatias de bacon e a maionese da casa, no pão australiano.', 45.00, 2),
	(3, 'Cerveja Coronita Long Neck 210ml', NULL, 5.99, 3);
...
-- Dumping data for table projtest.mesas: ~0 rows (approximately)
INSERT INTO `mesas` (`id_mesa`, `id_garçom`) VALUES
	(2, NULL),
	(1, '01d2475f-6d22-426d-85f1-f56f4f62a43c');
...
-- Dumping data for table projtest.opções_prato_index: ~0 rows (approximately)
INSERT INTO `opções_prato_index` (`id_opção_index`, `título`, `comentário`) VALUES
	(1, 'Ponto da carne', NULL),
	(2, 'Adicionar ingrediente', 'Para burgers'),
	(3, 'Adicionar ingrediente', 'Para prato executivo');
...
-- Dumping data for table projtest.opções_prato_opções: ~0 rows (approximately)
INSERT INTO `opções_prato_opções` (`id_opção`, `id_opção_index`, `opção`) VALUES
	(1, 1, 'Bem passada'),
	(2, 1, 'Ao ponto'),
	(3, 1, 'Mal passada'),
	(4, 2, 'Ovo frito'),
	(5, 2, 'Queijo'),
	(6, 3, 'Salada de maionese');
...
-- Dumping data for table projtest.prato_opções: ~0 rows (approximately)
INSERT INTO `prato_opções` (`id`, `id_prato`, `id_opção_index`) VALUES
	(1, 1, 1),
	(2, 2, 1),
	(3, 2, 2),
	(4, 1, 3);
...
-- Dumping data for table projtest.qr_codes: ~0 rows (approximately)
...
-- Dumping data for table projtest.qr_itens: ~0 rows (approximately)
INSERT INTO `qr_itens` (`id`, `id_prato`, `id_qr`) VALUES
	(1, 1, 1),
	(2, 3, 1),
	(3, 2, 2),
	(4, 3, 3);
...
-- Dumping data for table projtest.tipo_prato: ~0 rows (approximately)
